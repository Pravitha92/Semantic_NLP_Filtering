...
class PaperClassifier:
    def __init__(self, filepath):
        ...
        self.original_count = len(self.data)  # Store original dataset count
    ...
    def classify_and_save(self, classification_file="classified_papers.csv", detailed_file="filtered_papers_with_methods.csv"):
        ...
        # Calculate the percentage of papers filtered out
        relevant_count = self.data[self.data['method_type'] != "other"].shape[0]
        filtered_out_percentage = ((self.original_count - relevant_count) / self.original_count) * 100
        print(f"Percentage of total dataset filtered out: {filtered_out_percentage:.2f}%")
        ...
        #print(f"Full results with methods saved to {detailed_file}")
